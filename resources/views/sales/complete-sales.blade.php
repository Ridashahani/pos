            ...
            <div class="col-lg-12">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        ...
                        <p class="mb-0">List of all completed sales. You can view details or reprint invoices.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('sale.completeSales') }}" method="get">
                                ...
                                <tbody class="ligth-body">
                                    @forelse ($sales as $sale)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-success">{{ ucfirst($sale->sale_status) }}</span>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center list-action">
                                                    ...
                                                    <a class="btn btn-warning mr-2" data-toggle="tooltip"
                                                        ...
                                                        href="{{ route('sale.invoiceDownload', $sale->id) }}">
