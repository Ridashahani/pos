...
<head>
    <title>POS Invoice #{{ $sale->invoice_no }}</title>
                    ...
                    <div class="invoice-inner-9" id="invoice_wrapper">
                        ...
                        <div class="invoice-top">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div class="invoice">
                                        <h1>#<span>{{ $sale->invoice_no }}</span></h1>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="invoice-info">
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-50">
                                    ...
                                    <p class="inv-from-1">{{ $sale->customer->name }}</p>
                                    <p class="inv-from-1">{{ $sale->customer->email }}</p>
                                    <p class="inv-from-1">{{ $sale->customer->phone }}</p>
                                    <p class="inv-from-2">{{ $sale->customer->address }}</p>
                                </div>
                                <div class="col-sm-6 text-end mb-50">
