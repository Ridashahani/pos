...
<div class="container-fluid product-form-page">
    ...
    <div class="card"><div class="card-body">
        <form action="{{ $formAction }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-section-heading"><span class="form-section-number">01</span><div><h5>Product information</h5><p>Set the identity and inventory details for this product.</p></div></div>
            <div class="row">
            ...
            <div class="form-section-heading section-divider"><span class="form-section-number">02</span><div><h5>Product type</h5><p>Choose how this product should be priced and stocked.</p></div></div>
            ...
            <div class="form-section-heading section-divider pricing-section-heading"><span class="form-section-number">03</span><div><h5>Pricing and stock</h5><p>Set prices, taxes, stock alerts, and the opening quantity.</p></div></div>
            ...
            <div class="pricing-fields row">
                <div class="single-pricing-field form-group col-md-3"><label>Product Cost <span class="text-danger">*</span></label><div class="input-group"><input name="single_product_cost" value="{{ $field('product_cost', $field('buying_price')) }}" type="number" step="0.01" class="form-control single-input"><div class="input-group-append"><span class="input-group-text">$</span></div></div></div>
                <div class="single-pricing-field form-group col-md-3"><label><span class="single-label">Product Retail Price</span><span class="variation-label">Product Price</span> <span class="text-danger">*</span></label><div class="input-group"><input name="single_product_price" value="{{ $field('product_price', $field('selling_price')) }}" type="number" step="0.01" class="form-control single-input"><div class="input-group-append"><span class="input-group-text">$</span></div></div></div>
...
<style>
    .product-form-page { max-width: 1440px; padding-bottom: 24px; color: #24324a; }
    .product-form-page .form-card { border: 0; border-radius: 10px; box-shadow: 0 8px 28px rgba(35, 54, 84, .08); }
    .product-form-page > .card { border: 0; border-radius: 10px; box-shadow: 0 8px 28px rgba(35, 54, 84, .08); }
    .product-form-page > .card > .card-body { padding: 28px 30px; }
    .product-form-page .form-group { margin-bottom: 20px; }
    .product-form-page label { display: block; margin-bottom: 8px; color: #34435b; font-size: .78rem; font-weight: 600; letter-spacing: .01em; }
    .product-form-page .form-control { height: 42px; border: 1px solid #d9e0ea; border-radius: 6px; color: #26364f; background: #fff; font-size: .84rem; box-shadow: none; transition: border-color .15s ease, box-shadow .15s ease; }
    .product-form-page .form-control-file { width: 100%; height: 42px; padding: 9px 10px; border: 1px solid #d9e0ea; border-radius: 6px; color: #6d7b8f; background: #fff; font-size: .78rem; }
    .product-form-page .form-control:focus { border-color: #6474f5; box-shadow: 0 0 0 3px rgba(100, 116, 245, .12); }
    .product-form-page textarea.form-control { height: auto; min-height: 88px; resize: vertical; }
    .product-form-page .form-control::placeholder { color: #9aa6b6; }
    .product-form-page .input-group-text { border-color: #d9e0ea; background: #f3f5f8; color: #69778b; }
    .form-section-heading { display: flex; align-items: center; gap: 12px; margin: 4px 0 22px; }
    .form-section-heading.section-divider { border-top: 1px solid #e7ebf1; padding-top: 24px; margin-top: 6px; }
    .form-section-number { display: inline-flex; align-items: center; justify-content: center; width: 30px; height: 30px; border-radius: 7px; background: #eef0ff; color: #5e6df2; font-size: .72rem; font-weight: 700; }
    .form-section-heading h5 { margin: 0 0 3px; color: #26364f; font-size: 1rem; font-weight: 700; text-transform: capitalize; }
    .form-section-heading p { margin: 0; color: #8a96a8; font-size: .76rem; }
    .variation-only,.pricing-fields,.pricing-section-heading{display:none}.product-form-page.is-single .pricing-fields,.product-form-page.is-single .pricing-section-heading{display:flex}.product-form-page.is-variation .variation-only{display:block}.product-form-page.is-variation:not(.has-variation-selection) .variation-types-picker{display:none}.product-form-page.is-variation .variation-details{display:none}.product-form-page.is-variation.has-variation-types .variation-details,.product-form-page.is-variation.has-variation-types .pricing-section-heading,.product-form-page.is-variation.has-variation-types .pricing-fields{display:flex}.product-form-page.is-variation .single-pricing-field{display:none}.variation-label{display:none}.product-form-page.is-variation .single-label{display:none}.product-form-page.is-variation .variation-label{display:inline}
    .multi-picker{position:relative}.multi-picker-toggle{background:#fff;text-align:left;display:flex;align-items:center;justify-content:space-between;color:#6c757d;cursor:pointer}.multi-picker-chevron{font-size:12px;color:#adb5bd}.multi-picker-menu{display:none;position:absolute;z-index:20;top:calc(100% + 3px);left:0;right:0;max-height:190px;overflow-y:auto;background:#fff;border:1px solid #dce1e6;border-radius:6px;box-shadow:0 8px 20px rgba(35,54,84,.14);padding:6px}.multi-picker.open .multi-picker-menu{display:block}.multi-picker-menu label{display:flex;align-items:center;gap:8px;padding:9px 10px;margin:0;border-radius:4px;cursor:pointer;font-size:.82rem}.multi-picker-menu label:hover{background:#f1f3f8}.multi-picker-menu input{margin:0}.picker-values{display:none}.multi-picker-label{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding-right:8px}
    .product-form-page .btn-primary { background: #6372f4; border-color: #6372f4; border-radius: 6px; padding: 10px 22px; font-weight: 600; }
    .product-form-page .btn-secondary,.product-form-page .btn-outline-primary { border-radius: 6px; padding: 10px 22px; }
    @media (max-width: 767px) { .product-form-page > .card > .card-body { padding: 20px 16px; } .form-section-heading p { display: none; } }
</style>
<script>
(function () {
    ...
    if (barcodeScanner) barcodeScanner.addEventListener('change', function () { document.getElementById('code').value = this.value; });
}());
</script>