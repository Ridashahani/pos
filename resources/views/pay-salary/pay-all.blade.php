            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pay-salary.payAllStore') }}" method="POST">
                        ...
                        {{-- Actions --}}
                        <div class="mt-2">
                            <button type="submit" class="btn btn-save mr-2" onclick="return confirm('Are you sure you want to process payroll for ALL employees for this month?')">
                                <x-heroicon-o-currency-dollar class="w-5 h-5 mr-1 inline" /> Process All Payments
                            </button>
                            <a class="btn btn-cancel" href="{{ route('pay-salary.index') }}">
