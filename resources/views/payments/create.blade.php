        ...
        <div class="col-lg-12">
            <div class="card card-block card-stretch card-height">
                <div class="card-header bg-primary text-white d-flex align-items-center justify-content-between">
                    <h4 class="card-title mb-0">Add Payment Transaction</h4>
                    ...
                    <form action="{{ route('payments.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="customer_phone" name="customer_phone" value="{{ old('customer_phone') }}" class="form-control @error('customer_phone') is-invalid @enderror">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="datetime-local" id="transaction_date" name="transaction_date" value="{{ old('transaction_date', now()->format('Y-m-d\TH:i')) }}" class="form-control @error('transaction_date') is-invalid @enderror" required>
